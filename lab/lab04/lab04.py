...
def if_this_not_that(i_list, this):
    ...
    5
    """
    # The star op expands arrays or generators, similar to the spread op from javascript
    print(*(i if i > this else "that" for i in i_list), sep="\n")
...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    dummy_city = make_city('null', lat, lon)
    if distance(city1, dummy_city) < distance(city2, dummy_city):
